...
exports.run = async(client, msg, args, prefix) => {
    ...
    let help = new Discord.MessageEmbed()
        .setDescription(`${prefix}도박 <코인>`)
        .setColor("7289DA")
        .setFooter("코인 부분은 무조건 정수로 적어주세요.")
        ...
        collectorYes.on('collect', () => { // 반응을 할 경우
            ...
            if (boolean == 1) {
                ...
                let fail = new Discord.MessageEmbed()
                    .setDescription(`당신은 도박을 실패하여 거신 코인을 모두 잃었습니다.\n\n 보유하고 있는 코인: ||${yourmoney}₩||`)
                    .setColor("7289DA")
                msg.reply(fail)
...
exports.config = {
    ...
    aliases: ['도박'],
    category: ['ECONOMY'],
    des: ['당신이 꿀꿀코인을 걸어 반반의 확률로 게임을 진행합니다.'],
    use: ['ㄲ 도박 <코인>']
}